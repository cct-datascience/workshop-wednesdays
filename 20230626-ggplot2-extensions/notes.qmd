...
Go through introductory [slides](https://cct-datascience.quarto.pub/exploring-the-wide-world-of-ggplot2-extensions/) to start. Spend time looking through the ggplot extension gallery and ask if there are any particular packages that look useful to folks. Get people to share their discoveries.
