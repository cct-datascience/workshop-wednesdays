...
-   [r-lib/actions/setup-renv](https://github.com/r-lib/actions/tree/v2-branch/setup-renv): if your project uses [renv](https://rstudio.github.io/renv/articles/renv.html), it will install the R packages in the `renv.lock` file in your repository
