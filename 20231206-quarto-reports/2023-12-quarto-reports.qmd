...
[An example Quarto research report](https://viz.datascience.arizona.edu/quarto-workshop-example1/)

Or go to the URL: https://viz.datascience.arizona.edu/quarto-workshop-example1/

[Source code for this example](https://github.com/diazrenata/squareone-quarto/blob/main/s3_biomass.qmd)

Or go to the URL: https://github.com/diazrenata/squareone-quarto/blob/main/s3_biomass.qmd
...
-   Example: https://cct-datascience.quarto.pub/quartoworkshopexample1/
:::
...
-   Example: https://viz.datascience.arizona.edu/quarto-workshop-example1/
:::
