...
-   [An example Quarto research report](https://viz.datascience.arizona.edu/quarto-workshop-example/)

    -   Or go to the URL: <https://viz.datascience.arizona.edu/quarto-workshop-example/>
...
Let's start from this R script: [https://]
