...
```{r}
#| eval: false
here() #prints absolute path to current project directory
...
-   Commit ("convert to package") and push

-   Inspect GitHub, notice how README.md is rendered
...
-   Set up an [r-universe](https://ropensci.org/r-universe/) so people can install your package with `install.pacakges()`
