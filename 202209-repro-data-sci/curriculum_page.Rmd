...
3. GitHub authentication with PAT using [Jenny Bryan's Git book chapter 9](https://happygitwithr.com/https-pat.html) or with ssh using [Software Carpentry Version Control #7](https://swcarpentry.github.io/git-novice/07-github/index.html) section #3
