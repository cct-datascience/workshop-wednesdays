...
5. [Software Carpentry Version Control with Git episode #5](https://swcarpentry.github.io/git-novice/05-history/index.html)
6. (optional) [Software Carpentry Version Control with Git episode #6](https://swcarpentry.github.io/git-novice/06-ignore/index.html)
...
3. [Software Carpentry Version Control with Git episode #7](https://swcarpentry.github.io/git-novice/07-github/index.html)
4. [Software Carpentry branching add-on](http://erdavenport.github.io/git-lessons/10-branching.html)
...
Apply one or more of the organizing principles of a research compendium to an existing reserach project. 
