...
To introduce ecologists and other life scientists to better practices for sharing their code and results, managing their projects, and improving reproducility of their computational work. No prerequisite knowledge is necessary. 

## Instructional objectives

**Share & collaborate**: Learn how to do version control for code and data files
- Tools: shell, git & GitHub via the RStudio terminal pane

**Project management & reproducibility**: learn how to organize projects, use coding better practices, and intermediate R skills (for loops, functions)
- Tools: RStudio projects, dplyr/tidyr/ggplot2

**Documentation & publication**: learn how to write project READMEs and publicly publish reports
...
| Lesson  | Theme | Topic   |  Instructor	 |
|---|---|---|---|
| 1  | Share & collaborate | [Shell scripting](#lesson-1)  | Kristina |
| 2 | Share & collaborate | [Version control with git](#lesson-2) | Jessica | 
| 3  | Share & collaborate | [Sharing with GitHub](#lesson-3)  | Jessica |
| 4  | Project management & reproducibility | [Project management and coding best practices](#lesson-4) | Kristina |
| 5 | Project management & reproducibility | [Data manipulation](#lesson-5)  | Jessica |
| 6 | Project management & reproducibility | [Reproducibility of R code part 1](#lesson-6)  | Kristina |
| 7 | Project management & reproducibility | [Reproducibility of R code part 2 and plotting part 1](#lesson-7) | Jessica |
| 8 | Documentation & publication | [Plotting part 2 and documentation](#lesson-8)  | Kristina |

## Definitions of lesson section headers

**"Installation & materials"**: links to all lesson materials used, which were various Carpentries lessons
...
- [Software Carpentry Version Control with Git](https://swcarpentry.github.io/git-novice/) lessons #2, #3, & #4
...
- [Software Carpentry Version Control with Git](https://swcarpentry.github.io/git-novice/) lessons #6, #7, & #8
...
They will also get more comfortable with versional control through learning and doing pull requests and reinforcement of git cycle
...
- After introducing concept of R projects, walk through turning their local copy of forked repo into on
- To practice git, add `*.Rproj` to `.gitignore`, then commit and push to remote repo
...
- [Data carpentry R ecology lesson](https://datacarpentry.org/R-ecology-lesson/03-dplyr.html) - #3 'Manipulating, analyzing, and exporting data'
...
Reproducibility of R code part 2 and plotting part 1
...
Plotting part 2 and documentation
...
- Practice markdown and README concepts by adding a "Project files" section to their forked local repo README
...
ESA, Teresa, Frank, NEON, Carpentries
