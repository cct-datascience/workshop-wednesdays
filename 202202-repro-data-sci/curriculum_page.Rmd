---
title: "Reproducibility & Data Science Skills curriculum page"
...
To introduce CALS researchers to better practices for sharing their code and results, managing their projects, and improving reproducibility of their computational work. No prerequisite knowledge is necessary. 
...
2. **Project management & reproducibility**
    - Learn how to organize projects, use coding better practices, and intermediate R skills 
    - *Tools*: RStudio projects, base R, dplyr/tidyr/ggplot2

3. **Documentation & publication**
    - Learn how to write project READMEs and publicly publish reports
    - *Tools*: markdown, Rmarkdown files, RPubs, RStudio Connect

### General structure
This workshop was originally taught as a series of 8 two-hour virtual sessions, meeting twice a week for four weeks. We have now added two sessions. Lesson 4 is now optional extension to explore the foundations of collaborating on GitHub, including forking and pull requests. Lessons 6 thru 9 are now modular, meaning that they can be mixed and matched depending on learner interest. The final lesson now has a full 2 hour session, to allow time to cover publication of reports on RPubs and RStudio Connect. We believe that the full set of lessons will provide the most reinforcement necessary for adoption of these practices, but can also flexibly design shorter workshops depending on user demand. 
...
| 5  | Project management & reproducibility | [Project management and coding best practices](#lesson-5) |
| 6 (modular) | Project management & reproducibility  | [Intermediate R programming I](#lesson-6)  |
| 7 (modular) | Project management & reproducibility | [Intermediate R programming II](#lesson-7)  |
| 8 (modular) | Project management & reproducibility | [Data manipulation](#lesson-8)  |
| 9 (modular) | Project management & reproducibility | [Data visualization](#lesson-9) |
| 10 | Documentation & publication | [Documentation](#lesson-10)  |
...
**"Review"** suggests warm up activites to begin each session. 
...
**"Homework"** adds optional exercises and tasks to prepare for the next lesson.
...
##### Review
If anyone connected a local repository to GitHub, share how that went. Ask students to navigate to previous repository, ammend an existing file, and practice an add-commit-push cycle. 
...
#### Homework
Revise the plot_ts.R script to adhere to style guide and best practices. 
...
##### Review
To review the first 4-5 sessions, we can play the [jeopardy-style game](https://jeopardylabs.com/play/data-science-workshop-review-sessions-1-4) in a non-competitive fashion. 
...
##### Modifications
 ...
 - Show the diagram to illustrate wide versus long data, and why experimental units will differ based on the question asked
