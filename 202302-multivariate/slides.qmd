...
<!--# NAH, do the muir dataset instead -->
...
-   Decent plots (although custom `ggplot2` plots look nicer)
...
-   PLS is a supervised multivariable technique
...
-   When there's only one predictive axis and other axes are *orthogonal*, its OPLS
